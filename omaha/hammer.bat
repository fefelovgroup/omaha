...
:set_env_variables
set GOROOT=c:\go
set OMAHA_ATL_SERVER_DIR=c:\distrib\atl
...
set OMAHA_WIX_DIR=c:\distrib\wix310-binaries
set OMAHA_WTL_DIR=C:\distrib\wtl91
...
set SCT_DIR=C:\distrib\swtoolkit.0.9.1
